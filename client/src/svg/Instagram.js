        ...
        <svg x="0px" y="0px" viewBox="0 0 496 496">
            <g>
                <g>
                    <path
                        fill="#fff"
                        d="M290.912,214.208c-9.968-13.792-26.016-22.032-42.944-22.032s-32.976,8.24-42.944,22.048c-6.544,9.072-10,19.76-10,30.896
            ...
            <g>
                <g>
                    <path
                        fill="#fff"
                        d="M402.704,216.528h-79.376c-4.928,0-9.584,2.272-12.608,6.144s-4.112,8.928-2.928,13.712
            ...
            <g>
                <g>
                    <path
                        fill="#fff"
                        d="M396.704,145.696c-0.016,0-0.032,0-0.032,0L328,145.84l-0.144-52.608c-0.016-8.832-7.184-15.968-16-15.968
            ...
            <g>
                <g>
                    <g>
                        <path
                            fill="#fff"
                            d="M339.216,77.328H156.72c-42.288,0-79.392,34.32-79.392,73.44v182.48c0,38.448,36.64,85.424,79.392,85.424h182.496
                   ...
                   h182.496c24.4,0,47.456,20.144,47.456,41.44V333.248z"
                        ...
                        <path
                            fill="#fff"
                            d="M366.976,0H128.992C53.04,0,0,50.592,0,123.04v237.92C0,436.688,56.656,496,128.992,496h237.984
