        ...
        <svg x="0px" y="0px" viewBox="0 0 496 496">
            <g>
                <g>
                    <path
                        fill="#fff"
                        d="M303.792,230l-76.4-41.584c-4.96-2.688-10.96-2.592-15.824,0.304c-4.848,2.88-7.824,8.112-7.824,13.76l0.032,82.8
            ...
            <g>
                <g>
                    <g>
                        <path
                            fill="#fff"
                            d="M362,0H135.872C63.488,0,0,62.608,0,133.984v226.128C0,431.232,64.768,496,135.872,496H362
				...
				C82.48,464,32,413.52,32,360.112V133.984C32,80.608,81.504,32,135.872,32H362c53.376,0,102,48.608,102,101.984V360.112z"
                        ...
                        <path
                            fill="#fff"
                            d="M388.016,147.12c-14.336-15.6-30.576-17.536-38.896-18.512c-39.472-2.976-98.976-4.848-100.064-4.864h-0.144
